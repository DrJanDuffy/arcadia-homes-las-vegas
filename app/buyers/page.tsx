...
export const metadata: Metadata = {
  ...
  description:
    "Looking to buy a home in Las Vegas? Dr. Jan Duffy with Berkshire Hathaway HomeServices Nevada Properties guides you through every step. Free buyer consultation. Call (702) 500-0337.",
  keywords: [
    "buy home Las Vegas",
        ...
        <div className="container mx-auto px-4">
          ...
          <section className="mb-16 max-w-4xl mx-auto">
            ...
            <p className="text-slate-600 text-center max-w-3xl mx-auto mb-8">
              ...
              see your question here, call Dr. Jan Duffy at (702) 500-0337 for a free consultation.
            </p>
