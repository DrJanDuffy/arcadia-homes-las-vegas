...
export const metadata: Metadata = {
  title: "Contact Dr. Jan Duffy | Arcadia Homes Las Vegas",
  description:
    "Contact Dr. Jan Duffy at Berkshire Hathaway HomeServices Nevada Properties. Schedule an appointment or call (702) 500-0337. Arcadia & Summerlin West real estate.",
  keywords: [
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-blue-100">(702) 500-0337</div>
                </div>
              </a>
              <a
                href="mailto:DrDuffy@arcadiahomeslasvegas.com"
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  a: "I typically respond to calls, texts, and emails within 2 hours during business hours (9am-6pm daily). For urgent matters, calling or texting (702) 500-0337 is the fastest way to reach me.",
                },
                {
