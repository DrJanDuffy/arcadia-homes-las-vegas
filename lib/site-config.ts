// Site Configuration - Arcadia Homes Las Vegas
// Berkshire Hathaway HomeServices Nevada Properties

export const siteConfig = {
  name: "Arcadia Homes Las Vegas",
  fullName: "Berkshire Hathaway HomeServices Nevada Properties",
  tagline: "Arcadia & Summerlin West Luxury Real Estate",
  brandLine:
    "Arcadia Homes Las Vegas | Berkshire Hathaway HomeServices Nevada Properties",
...
export const agentInfo = {
  ...
  phone: "(702) 500-0337",
  phoneFormatted: "(702) 500-0337",
  phoneTel: "tel:+17025000337",
